...
/* Before we can start storing data, we need a table to hold the data first. The code below, used PHP and SQL to dynamically create out database table and table values. */
